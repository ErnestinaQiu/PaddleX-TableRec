...
class DgcnnSegment(paddle.nn.Layer):
    ...
    def forward(self, x):
        ...
        dense_net3 = DenseLayer(output_dim=64)
        ...
        dense1 = DenseLayer(output_dim=128)
        feat = dense1(feat)
        dense2 = DenseLayer(output_dim=128)
        feat = dense2(feat)
        return feat
